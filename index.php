...
<body>
    ...
    <div id="statsContainer">
        ...
        <div id="champSelectContainer" class="container">
            <table id="championFilters" style="text-align:left">
                <tr>
        ...
        <div id="summonerStats" style="display:none" class="container">
        ...
        <div id="matchesContainer" class="container"></div>
    </div>
...
'</table>'
                                ...
                                $('AVGTotalDTC').html("AVG Total Damage Taken: " + parseFloat((totalDamageToChampions/matchesLength).toFixed(2)));
                                $('#displayStats').show();
                                $('#summonerStats').show();
                            }
                        });
